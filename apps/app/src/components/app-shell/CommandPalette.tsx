...
import {
  ...
  PaletteSparkleIcon,
  PaletteStudyIcon,
} from "../icons/CommandPaletteIcons";
...
const ICONS = {
  study: <PaletteStudyIcon />,
  plus: <PalettePlusIcon />,
  sparkle: <PaletteSparkleIcon />,
  import: <PaletteImportIcon />,
  settings: <PaletteSettingsIcon />,
  space: <PaletteSpaceIcon />,
  card: <PaletteCardIcon />,
  grid: <PaletteGridIcon />,
  list: <PaletteListIcon />,
  arrow: <PaletteArrowIcon />,
};
